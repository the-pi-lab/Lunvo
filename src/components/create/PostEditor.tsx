      ...
      <div className="lg:col-span-7 space-y-6">
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm flex flex-col overflow-hidden">
          <div className="flex items-center justify-between p-4 border-b border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50">
            ...
            <button
              onClick={handleCopy}
              className="flex items-center space-x-1 px-3 py-1.5 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-md text-xs font-medium hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-colors"
            >
          ...
          <textarea
            ...
            className="w-full flex-1 min-h-[300px] p-6 bg-transparent resize-none outline-none text-slate-800 dark:text-slate-200 leading-relaxed font-sans"
          />
        </div>

        {/* 1-Click Optimizer */}
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-sm">
          <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-2 flex items-center">
          ...
          <div className="flex space-x-2">
            <input 
              ...
              className="flex-1 rounded-md border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-950 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-blue-500"
            />
            <button 
              onClick={handleOptimize}
              disabled={isOptimizing || !optimizerInstruction.trim()}
              className="px-4 py-2 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-md text-sm font-medium hover:bg-slate-800 disabled:opacity-50 transition-colors"
            >
      ...
      <div className="lg:col-span-5 space-y-6">
        ...
        <div className="relative">
          ...
          {!metrics && !isPredicting && (
             <div className="absolute inset-0 bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm flex items-center justify-center rounded-xl z-10 border border-transparent">
               <button onClick={handlePredict} className="px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium shadow-sm hover:bg-blue-700 transition-colors">
        ...
        <div>
          <h3 className="text-sm font-semibold text-slate-900 dark:text-white mb-3">Mobile Preview (Truncation Check)</h3>
